...
const translateUrl = "https://nhentai-net.translate.goog/g/";
...
module.exports = class nHentai {
  ...
  g_transpipe(query) {
    let id = query.slice(translateUrl.length, translateUrl.length+6);
    console.log(id);
    return request.getBook(id);
  }
