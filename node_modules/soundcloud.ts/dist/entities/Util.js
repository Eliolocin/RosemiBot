...
var Util = exports.Util = /** @class */ (function (_super) {
    ...
    function Util() {
        ...
        _this.resolveTrack = function (trackResolvable) { return __awaiter(_this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(typeof trackResolvable === "string")) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.sc.tracks.getV2(trackResolvable)];
                    case 1:
                        _a = _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
        ...
        _this.sortTranscodings = function (trackResolvable, protocol) { return __awaiter(_this, void 0, void 0, function () {
        ...
        _this.getStreamLink = function (transcoding) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _c.trys.push([2, 4, , 10]);
                        return [4 /*yield*/, makeRequest(url + connect, { headers: headers })
         ...
         */
        _this.streamLink = function (trackResolvable, protocol) { return __awaiter(_this, void 0, void 0, function () {
            var track, transcodings;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.resolveTrack(trackResolvable)];
        ...
        _this.mergeFiles = function (files, outputFile) { return __awaiter(_this, void 0, void 0, function () {
        ...
        _this.spawnFFmpeg = function (argss) {
            try {
         ...
         */
        _this.m3uReadableStream = function (trackResolvable) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, makeRequest(transcoding.url + connect, { headers: this.api.headers })
                                .then(function (r) { return r.json(); })
                                .then(function (r) { return r.url; })];
                    case 4:
                        m3uLink = _a.sent();
                        ...
                        return [3 /*break*/, 12];
                    case 5: return [4 /*yield*/, makeRequest(m3uLink, { headers: headers }).then(function (r) { return r.text(); })];
                    case 6:
                        m3u = _a.sent();
         ...
         */
        _this.downloadTrackStream = function (trackResolvable, title, dest) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        url = _a.sent();
                        headers = this.api.headers;
                        return [4 /*yield*/, makeRequest(url, { headers: headers })];
                    case 6:
                        stream_2 = _a.sent();
         ...
         */
        _this.downloadTrack = function (trackResolvable, dest) { return __awaiter(_this, void 0, void 0, function () {
            var track;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
         ...
         */
        _this.downloadTracks = function (tracks, dest, limit) { return __awaiter(_this, void 0, void 0, function () {
         ...
         */
        _this.downloadSearch = function (query, dest, limit) { return __awaiter(_this, void 0, void 0, function () {
            var tracks;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sc.tracks.searchV2({ q: query })];
                    case 1:
                        tracks = _a.sent();
         ...
         */
        _this.downloadLikes = function (userResolvable, dest, limit) { return __awaiter(_this, void 0, void 0, function () {
            var tracks;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sc.users.likes(userResolvable, limit)];
                    case 1:
                        tracks = _a.sent();
         ...
         */
        _this.downloadPlaylist = function (playlistResolvable, dest, limit) { return __awaiter(_this, void 0, void 0, function () {
            var playlist;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sc.playlists.getV2(playlistResolvable)];
                    case 1:
                        playlist = _a.sent();
         ...
         */
        _this.streamTrack = function (trackResolvable) { return __awaiter(_this, void 0, void 0, function () {
            var url, readable;
            return __generator(this, function (_a) {
                switch (_a.label) {
         ...
         */
        _this.downloadSongCover = function (trackResolvable, dest, noDL) { return __awaiter(_this, void 0, void 0, function () {
